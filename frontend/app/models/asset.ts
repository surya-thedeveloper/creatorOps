...
export default class AssetModel extends Model {
  ...
  @attr('string') declare assetType: 'RAW_VIDEO' | 'EDITED_VIDEO' | 'THUMBNAIL' | 'AUDIO_SFX' | 'DOCUMENT' | 'IMAGE' | 'OTHER';
  @attr('string') declare assetSource: 'GOOGLE_DRIVE' | 'ONEDRIVE' | 'LOCAL_UPLOAD' | 'FRAME_IO' | 'DROPBOX' | 'OTHER';
